...
function RapportListfamilleparticipant() {
    ...
    const fetchRapportList = (isLoading = true, mode = "list") => {
        ...
        formData.append("nonparticipant", "faux")
    ...
    const exportToExcel = (dataToExport) => {
        ...
        XLSX.writeFile(wb, 'Liste-participants.xlsx')
        hideLoader()
    }
...
export default RapportListfamilleparticipant;